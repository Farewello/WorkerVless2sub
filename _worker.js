...
// 设置优选地址api接口
let addressesapi = [
	'https://cf-workers-text2kv-9vy.pages.dev/ip.txt?token=1313521zxc..' //可参考内容格式 自行搭建。
];

let DLS = 6;//速度下限
let addressescsv = [
	//'https://cf-workers-text2kv-9vy.pages.dev/ce.csv?token=1313521zxc..' //iptest测速结果文件。
];
